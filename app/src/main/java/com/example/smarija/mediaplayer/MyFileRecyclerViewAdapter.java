...
import com.example.smarija.mediaplayer.FileFragment.OnListFragmentInteractionListener;
import com.example.smarija.mediaplayer.dummy.DummyContent.FileItem;
...
public class MyFileRecyclerViewAdapter extends RecyclerView.Adapter<MyFileRecyclerViewAdapter.ViewHolder> {
    ...
    public MyFileRecyclerViewAdapter(List<FileItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
